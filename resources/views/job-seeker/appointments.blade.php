        ...
        <div class="col-12 mt-4">
            <div class="d-md-flex align-items-center text-center justify-content-between">
                <ul class="pagination justify-content-center mb-0 mt-3 mt-sm-0">
                    <li class="page-item">
                        <a class="page-link"
                            href="{{route('jobSeeker.appointments', ['page' => getUrlParameters($appointments['links']['prev'], 'page', 1)])}}"
                            aria-label="Previous">Prev</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link"
                            href="{{route('jobSeeker.appointments', ['page' => getUrlParameters($appointments['links']['next'], 'page', 1)])}}"
